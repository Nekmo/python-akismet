...
PACKAGE_NAME = 'python-akismet'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/python-akismet/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/python-akismet'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['akismet', 'spam', 'protection', 'comments']  # Palabras clave
